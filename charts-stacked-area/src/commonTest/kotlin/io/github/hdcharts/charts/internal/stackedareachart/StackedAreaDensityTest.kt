...
class StackedAreaDensityTest {
    ...
    private fun toInternalData(data: io.github.hdcharts.charts.model.ChartData) =
        io.github.hdcharts.charts.internal.common.model.MultiChartData(
            items =
                data.series.map { series ->
                    io.github.hdcharts.charts.internal.common.model.ChartDataItem(
